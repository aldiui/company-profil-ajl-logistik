...
@section('main')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="city-table" width="100%">
                                    <thead>
                                        <tr>
                                            <th width="5%">#</th>
                                            <th>Kode</th>
    ...
    @include('pages.backend.city.modal')
@endsection
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            datatableCall('city-table', '{{ route('admin.city.index') }}', [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
                {
            ...
            $("#saveData").submit(function(e) {
                ...
                let url = "{{ route('admin.city.store') }}";
                ...
                const successCallback = function(response) {
                    ...
                    handleSuccess(response, "city-table", "createModal");
                };
